...
class GetRevocRegDefHandler(ReadRequestHandler):
    ...
    def get_result(self, request: Request):
        ...
        assert state_path
        try:
            keys, last_seq_no, last_update_time, proof, endorser = self.lookup(state_path, is_committed=True, with_proof=True)
        except KeyError:
            keys, last_seq_no, last_update_time, proof, endorser = None, None, None, None, None
